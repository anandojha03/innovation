...
mapping_img1 = {
    ...
    "Amount in Figures": "amt_in_figure",
...
prompt1 = f"Extract values of fields {fields1} in json from the first image and change there key name as {mapping_img1}"
response1 = model.generate_content([prompt1, image1])
print(response1.text)

prompt2 = f"extract values of fields {fields2} in json from second image and change there key name as {mapping_img2}"
response2 = model.generate_content([prompt2, image2])
